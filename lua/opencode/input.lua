...
function M.show(default, callback)
  ...
  require("snacks.input").input(
    vim.tbl_deep_extend("force", require("opencode.config").options.input, {
      default = default,
      win = {
        -- Do some setup. Not in default config object to keep that concise, and I don't expect users to modify this.
        on_buf = function(win)
          ...
          -- snacks.input doesn't seem to actually call `highlight`... so we have to highlight the buffer ourselves
